...
namespace BlazorApp1.Server.Migrations
{
    ...
    [Migration("20221205031315_services")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    b.Property<int>("ChildsClientId")
                        .HasColumnType("int");

                    b.Property<int>("ParentsClientId")
                        .HasColumnType("int");

                    b.HasKey("ChildsClientId", "ParentsClientId");
            ...
            modelBuilder.Entity("StudentTeacher", b =>
                {
                    b.Property<int>("StudentsClientId")
                        .HasColumnType("int");

                    b.Property<int>("TeachersClientId")
                        .HasColumnType("int");

                    b.HasKey("StudentsClientId", "TeachersClientId");
            ...
            modelBuilder.Entity("StudentTeacher", b =>
                {
                    b.HasOne("BlazorApp1.Shared.Models.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentsClientId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
