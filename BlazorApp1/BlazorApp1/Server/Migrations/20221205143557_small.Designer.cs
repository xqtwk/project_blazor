...
namespace BlazorApp1.Server.Migrations
{
    ...
    [Migration("20221205143557_small")]
    partial class small
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    ...
                    b.HasKey("Parents", "ParentsClientId");

                    b.HasIndex("ParentsClientId");
            ...
            modelBuilder.Entity("BlazorApp1.Shared.Models.Parent", b =>
                {
                    ...
                    b.ToTable("parentdetails", (string)null);
                });
            ...
            modelBuilder.Entity("BlazorApp1.Shared.Models.Parent", b =>
                {
                    b.HasOne("BlazorApp1.Shared.Models.Client", null)
                        .WithOne()
                        .HasForeignKey("BlazorApp1.Shared.Models.Parent", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlazorApp1.Shared.Models.Student", b =>
                {
                    b.HasOne("BlazorApp1.Shared.Models.Client", null)
                        .WithOne()
                        .HasForeignKey("BlazorApp1.Shared.Models.Student", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BlazorApp1.Shared.Models.Teacher", b =>
                {
                    b.HasOne("BlazorApp1.Shared.Models.Client", null)
                        .WithOne()
                        .HasForeignKey("BlazorApp1.Shared.Models.Teacher", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
